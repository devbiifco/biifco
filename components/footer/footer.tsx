  ...
  return (
    <footer className="border-t">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-12 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
          <div className="col-span-2">
            ...
            <p className="mt-4 text-sm text-muted-foreground max-w-xs">
              Revolutionizing the bovine supply chain with cutting-edge technology and transparency.
            </p>
        ...
        <div className="py-6 border-t flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <div className="flex flex-wrap justify-center md:justify-start gap-4">
            <span>© 2024 Biifco. All rights reserved.</span>
