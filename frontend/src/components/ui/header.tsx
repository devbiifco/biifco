        ...
        <div className="md:hidden bg-background shadow-md w-full fixed top-16 left-0 z-10">
          <nav className="flex flex-col items-center py-4 space-y-4">
            ...
            <div className="flex flex-col items-center space-y-2 pt-4">
              <a href="/login" className="hover:bg-accent py-1 px-4 rounded-full transition-all duration-300">Login</a>
              <a href="#signup" className="rounded bg-secondary text-white hover:text-white hover:bg-primary py-1 px-4 rounded-full transition-all duration-300">Contact</a>
              <a href="#signup" className="rounded bg-secondary text-white hover:text-white hover:bg-primary py-1 px-4 rounded-full transition-all duration-300">Sign Up</a>
            </div>
          </nav>
        </div>
      )}
